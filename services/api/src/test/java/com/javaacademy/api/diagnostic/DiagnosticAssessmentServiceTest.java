...
class DiagnosticAssessmentServiceTest {
    ...
    void startAssessmentCreatesInProgressAssessment() {
        ...
        verify(diagnosticAssessmentRepository).save(any(DiagnosticAssessment.class));
    }
    @Test
void getAssessmentsForUserReturnsUserAssessments() {
    ...
    verify(diagnosticAssessmentRepository).findByUser(user);
}
    ...
    void getAssessmentByIdReturnsExistingAssessment() {
        ...
        verify(diagnosticAssessmentRepository).findById(assessmentId);
    }
     @Test
void completeAssessmentChangesStatusToCompleted() {
    ...
    verify(diagnosticAssessmentRepository).findById(assessmentId);
    verify(diagnosticAssessmentRepository).save(assessment);
}
 @Test
